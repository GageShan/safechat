    ...
    function setSentMessageMap(friendList) {
        sentMessageMap = new SentMessageMap();
        for(var i = 0; i < friendList.length; i++) {
            var tp = sentMessageMap.get(friendList[i].userId);
